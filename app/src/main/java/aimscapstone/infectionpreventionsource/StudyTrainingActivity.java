...
public class StudyTrainingActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.resource_nav) {
            Intent openResourcesActivity = new Intent(StudyTrainingActivity.this, ResourcesActivity.class);
        ...
        {
            Intent openVideoActivity = new Intent(StudyTrainingActivity.this, MainVideoNavigationActivity.class);
        ...
        {
            Intent openChatActivity = new Intent(StudyTrainingActivity.this, ChatActivity.class);
        ...
        {
            Intent openMainActivity = new Intent(StudyTrainingActivity.this, MainActivity.class);
